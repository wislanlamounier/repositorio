							...
							<tr>
								<td>
									<?php
										...
										if($item->status){
											echo $this->botaoIcone('contasreceberimoveis/verpagamento/'.$item->id_pagamento, 'icon-search');
                                        }else{
											echo $this->botaoIcone('contasreceberimoveis/pagarparcela/'.$item->id, 'icon-thumbs-up');
...
<script type="text/javascript">
    $(function(){
        $('body').on('click','.excluir-parcela', function(){
            ...
            $.ajax({
                url: Url('contasreceberimoveis/excluir-parcela/'+id),
                type: 'get',
